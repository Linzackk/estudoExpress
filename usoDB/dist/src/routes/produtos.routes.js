...
const router = Router();
router.get("/id/:id", validarLerProdutoPorId, validarResultado, lerProduto);
router.get("/categoria/:categoria", validarLerProdutosPorCategoria, validarResultado, lerProdutosPorCategoria);
router.post("/", validarCriarProduto, validarResultado, criarProduto);
router.put("/:id", validarAtualizarProduto, validarResultado, atualizarProduto);
router.delete("/:id", validarDeletarProduto, validarResultado, deletarProduto);
